...
Academic family tree centered around Prof. Mack. To view the tree as a graph, click on "acad_tree.md" in the list of files (above on repo homepage, on the left if this README.md is opened on Github).
